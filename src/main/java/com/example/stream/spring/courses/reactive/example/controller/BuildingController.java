...
public class BuildingController {
    ...
    @PostMapping("/")
    public ResponseEntity<Mono<BuildingResponseDto>> createBuilding(@RequestBody BuildingRequestDto buildingRequestDto) {
        return ResponseEntity.ok(buildingService.createBuilding(buildingRequestDto));
    }
